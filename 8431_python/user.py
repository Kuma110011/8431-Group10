...
# name: nickname or true name
# user_id: unique identifier for us to see and for users to match others
...
class User:
    ...
    def _convert_to_list(self, attr, data_type):
        ...
        if isinstance(attr, str):
            # Filter out empty strings before converting to the desired data type
